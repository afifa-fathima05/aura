...
// ----- CSV helpers -----
const csvHeaders = [
  'membershipId', 'name', 'email', 'rollNumber', 'registerNumber', 'year', 'section'
]
          ...
          <button
            onClick={async () => {
              try {
                ...
                const ws = utils.json_to_sheet(rows, { header: ['membershipId', 'name', 'email', 'rollNumber', 'registerNumber', 'year', 'section'] })
